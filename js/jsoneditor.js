...
JSONEditor.AbstractTheme = Class.extend({
  ...
  getSwitcher: function(options) {
    ...
    switcher.style.backgroundColor = '#FFE9A6';
...
JSONEditor.defaults.themes.bootstrap3 = JSONEditor.AbstractTheme.extend({
  ...
  getTabHolder: function() {
    var el = document.createElement('div');
    el.innerHTML = "<ul class='nav nav-tabs' role='tablist'></ul><div role='tab-content'></div>";
    el.className = 'rows';
    return el;
  },
  getTab: function(text) {
    ...
    elA.className = 'tab-pane';
    elA.setAttribute('href','#');
    //el.setAttribute('aria-controls',text);
    elA.setAttribute('role','tab');
    elA.setAttribute('data-toggle','tab');
